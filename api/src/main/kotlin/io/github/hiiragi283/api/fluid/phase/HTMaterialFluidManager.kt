...
class HTMaterialFluidManager(
    private val fluidToPhased: Map<Fluid, HTPhasedMaterial>,
    ...
    class Builder(private val map: MutableMap<Entry, HTPhasedMaterial>) {
        @JvmOverloads
        fun add(
            ...
            add(HTPhasedMaterial(materialKey, phase), fluid, unification)
        }

        private fun add(part: HTPhasedMaterial, fluid: Fluid?, unification: Boolean = true) {
        ...
        fun add(
            ...
            add(HTPhasedMaterial(materialKey, phase), tag, unification)
        }

        private fun add(part: HTPhasedMaterial, tag: Tag<Fluid>, unification: Boolean = true) {
            part.checkValidation()

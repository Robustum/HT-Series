...
class HTMultiblockShape private constructor(private val posMap: Map<BlockPos, HTBlockPredicate>) :
    BiPredicate<World, BlockPos> {
        ...
        class Builder {
            ...
            private fun build(): HTMultiblockShape = HTMultiblockShape(posMap)

            companion object {
                @JvmStatic
                fun create(builderAction: Builder.() -> Unit): HTMultiblockShape = Builder().apply(builderAction).build()
            }

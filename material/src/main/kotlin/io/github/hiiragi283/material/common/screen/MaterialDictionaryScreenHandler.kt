...
class MaterialDictionaryScreenHandler(
    ...
    private fun updateInput(stack: ItemStack) {
        ...
        if (!stack.isEmpty) {
            availableEntries =
                HTApiHolder.Material.apiInstance.materialItemManager.convertibleItems(stack.item).toList()
        }
    }
    ...
    override fun getType(): ScreenHandlerType<*> = HTMaterials.screenHandlerType
    ...
    override fun transferSlot(player: PlayerEntity, index: Int): ItemStack {
        ...
        if (slot.hasStack()) {
            ...
            when (index) {
                ...
                else -> if (HTApiHolder.Material.apiInstance.materialItemManager.contains(itemStack2.item)) {
